            ...
            <div className="bg-[#181818] p-8 md:w-1/3">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">sohammondal50285@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">+91 8167303732</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/in/soham-mondal-2542b4257/" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors">
                  ...
                  <a href="https://github.com/" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
